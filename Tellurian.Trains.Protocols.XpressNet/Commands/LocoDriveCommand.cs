...
{
    public LocoDriveCommand(Address address, LocoSpeed speed, LocoDirection direction) : base(0xE0, GetData(address, speed, direction)) { }

    private static byte[] GetData(Address address, LocoSpeed speed, LocoDirection direction)
    {
