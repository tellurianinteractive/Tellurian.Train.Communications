...
public sealed class AccessoryFunctionCommand : Command {
    ...
    public AccessoryFunctionCommand(AccessoryAddress address, AccessoryOutput output, AccessoryOutputState state, AccessoryZ21Mode mode) : base(0x50, GetData(address, output, state, mode)) { }

    private static byte[] GetData(AccessoryAddress address, AccessoryOutput output, AccessoryOutputState state) {
    ...
    private static byte[] GetData(AccessoryAddress address, AccessoryOutput output, AccessoryOutputState state, AccessoryZ21Mode mode) {
