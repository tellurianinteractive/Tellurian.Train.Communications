...
public class ProgramOnMainWriteByteCommandTests
{
    ...
    {
        var target = new ProgramOnMainWriteByteCommand(Address.From(3), new CV(1, 0x55));
    ...
    {
        var target = new ProgramOnMainWriteByteCommand(Address.From(9999), new CV(256, 0xAA));
        var data = target.GetData();
    ...
    {
        var target = new ProgramOnMainWriteByteCommand(Address.From(3), new CV(257, 0x42));
        var data = target.GetData();
    ...
    {
        var target = new ProgramOnMainWriteByteCommand(Address.From(3), new CV(513, 0x77));
        var data = target.GetData();
    ...
    {
        var target = new ProgramOnMainWriteByteCommand(Address.From(3), new CV(769, 0x99));
        var data = target.GetData();
    ...
    {
        var target = new ProgramOnMainWriteByteCommand(Address.From(3), new CV(1024, 0xBB));
        var data = target.GetData();
