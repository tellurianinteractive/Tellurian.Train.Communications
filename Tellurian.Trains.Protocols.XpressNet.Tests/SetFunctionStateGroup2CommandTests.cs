...
public class SetFunctionStateGroup2CommandTests
{
    ...
    {
        var target = new SetFunctionStateGroup2Command(LocoAddress.From(3), true, true, true, true);
    ...
    {
        var target = new SetFunctionStateGroup2Command(LocoAddress.From(3), true, false, false, false);
        var data = target.GetData();
